...
symbol_demo_text = (
    "今天，ＡＩ研究社說：“南京市长江大桥真美！”同學们用Python＋正則表達式，"
    "測試全角／半角、繁體與简体清洗。#NLP@2026"
)
frequency_demo_text = (
    "在自然语言处理课上，我们先收集文本、文本、文本、文本、文本，观察它如何影响词频统计。"
    "随后大家比较模型、模型、模型的分词结果，发现不同方法会给出不同边界。"
    "老师又提醒我们检查数据、数据质量，因为清洗后的语料更适合展示。"
    "最后同学们记录词频、标注关键词，并讨论中文分词在课堂演示中的价值。"
)
